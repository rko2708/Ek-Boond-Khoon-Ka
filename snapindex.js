...
try {
    mongoose.connect('mongodb://localhost:27017/mybloodbank', { useNewUrlParser: true, useCreateIndex: true });
} catch (error) {
    throw error;
}

// mongoose.connect(
//     'mongodb://localhost:27017/myblood', { useNewUrlParser: true, useCreateIndex: true },
//     (err) => {
//         if (err) throw err;
